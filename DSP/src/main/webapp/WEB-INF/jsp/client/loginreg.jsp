...
<link href=<%=path+"/css/loginreg.css" %> rel="stylesheet" type="text/css" />
<script type="text/javascript" src=<%=path+"/js/jquery-3.3.1.js"%>></script>
<script type="text/javascript" src=<%=path+"/js/loginreg.js"%>></script>
</head>
<body>
<h1>欢迎来到<sup>V2014</sup></h1>
			...
			<div class="login_form">
               ...
               <input type="hidden" name="to" value="log"/>
                ...
                <div class="inputOuter" id="uArea">
                    ...
                    <input type="text" id="u" name="username" placeholder="请输入账号" class="inputstyle"/>
                </div>
                </div>
                <div class="pwdArea" id="pwdArea">
               <label class="input-tips" for="p">密码：</label> 
               <div class="inputOuter" id="pArea">
                    <input type="password" id="p" name="p" placeholder="请输入密码" class="inputstyle"/>
                </div>
                </div>
               <div class="uinArea" id="code">
               <label class="input-tips" for="c">验证码：</label> 
               <div class="inputOuter" id="pArea">
                    <input type="text" id="c" name="p" placeholder="请输入验证码" class="inputstyle"/>
                	<img alt="" src="">
                </div>
                </div>
